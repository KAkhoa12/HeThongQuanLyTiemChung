...
const StaffListPage = () => {
  ...
  const fetchStaffList = async () => {
    try {
      setLoading(true);
      const response: PagedResponse<Staff> = await getAllStaff(
        pagination.currentPage,
        pagination.pageSize
      );
      ...
      <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        ...
        <div className="max-w-full overflow-x-auto">
          {loading ? (
            ...
            <div className="text-center py-10">
              <p className="text-lg text-gray-500">Không tìm thấy nhân viên nào</p>
            </div>
          ) : (
              ...
              <tbody>
                {staffList.map((staff) => (
                  <tr key={staff.id}>
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white">{staff.email}</p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white">{staff.phone || 'N/A'}</p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                      <p className="text-black dark:text-white">{staff.role}</p>
                    </td>
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
